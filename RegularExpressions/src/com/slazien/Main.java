...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String h2GroupPattern = "(<h2>.*?</h2>)"; // * is a greedy quantifier, we want a lazy one
...
//        String tNotVRegExp = "t[^v]";
        ...
        System.out.println("phone1 = " + phone1.matches(phoneRegEx));
        System.out.println("phone2 = " + phone2.matches(phoneRegEx));
        System.out.println("phone3 = " + phone3.matches(phoneRegEx));
        System.out.println("phone4 = " + phone4.matches(phoneRegEx));
