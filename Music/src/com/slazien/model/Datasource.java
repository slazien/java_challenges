...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/home/slazien/Downloads/" + DB_NAME;
    ...
    public List<String> queryAlbumsForArtist(String artistName, int sortOrder) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                // only one column in the result set, so can use 1 with no problems
    ...
    private int insertArtist(String name) throws SQLException {
        ...
        if (results.next()) {
            ...
            // Insert the artist, because doesn't exist
    ...
    private int insertAlbum(String name, int artistId) throws SQLException {
        ...
        if (results.next()) {
            ...
            // Insert the album, because doesn't exist
